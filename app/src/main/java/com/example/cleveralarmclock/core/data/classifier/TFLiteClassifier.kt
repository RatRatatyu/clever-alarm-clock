...
//This method of implementing the task using the on-device model has been discontinued due to a lack of time to analyze
//and find a good dataset. A different implementation method will be used, but it is planned to return to this method.
