                ...
                Box(
                    ...
                    Column(
                        ...
                        Icon(
                            ...
                            contentDescription = stringResource(R.string.shake_phone),
                            modifier = Modifier
                                .size(90.dp)
                        ...
                        Text(
                            text = if(isTaskFinished) stringResource(R.string.well_done) else stringResource(
                                R.string.shake_your_phone
                            ),
